...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable list = get_photo_list(channel_id, category_id, 12, page, "", out totalcount);
	...
	templateBuilder.Append("\r\n     <li><a href=\"");
	templateBuilder.Append(linkurl("photo_show",dr["id"].ToString().Trim()));

	templateBuilder.Append("\"><img src=\"" + dr["img_url"].ToString().Trim() + "\" width=\"196\" height=\"196\" alt=\"" + dr["title"].ToString().Trim() + "\" /><span>" + dr["title"].ToString().Trim() + "</span></a>\r\n     </li>\r\n     ");
	}	//end loop
	...
	DataTable photo_top8 = get_photo_list(channel_id, category_id, 8, "is_lock=0", "click desc,add_time desc");
