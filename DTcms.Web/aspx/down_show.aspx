...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.webpath.ToString());
	templateBuilder.Append("', 'download', '");
	...
	templateBuilder.Append("\r\n <!-- /.header -->\r\n <div class=\"clear\"></div>\r\n <div class=\"grid_8\">\r\n  ");
	string category_nav = get_category_menu("down_list1", model.category_id);
	...
	templateBuilder.Append("\r\n      <li><span><a target=\"_blank\" href=\"");
	templateBuilder.Append(config.webpath.ToString());
	templateBuilder.Append("tools/download.ashx?id=");
	templateBuilder.Append(modelt1.id.ToString());
	templateBuilder.Append("\">点击下载</a></span>附件");
	templateBuilder.Append(modelt1__loop__id.ToString());
	templateBuilder.Append("：");
	templateBuilder.Append(modelt1.title.ToString());
	templateBuilder.Append("<i>大小：\r\n      ");
	...
	templateBuilder.Append("\r\n       ");
	templateBuilder.Append(tempSize.ToString());
	...
	templateBuilder.Append("\r\n      ");
	templateBuilder.Append(modelt1.file_size.ToString());
	templateBuilder.Append("KB\r\n      ");
	}	//end if


	templateBuilder.Append("\r\n      </i><i>下载：");
	templateBuilder.Append(modelt1.down_num.ToString());
	templateBuilder.Append("次</i></li>\r\n      ");
	}	//end loop
	...
	DataTable down_list5 = get_download_list(channel_id, model.category_id, 5, "is_lock=0", "click desc,add_time desc");
	

	int ddr5__loop__id=0;
	foreach(DataRow ddr5 in down_list5.Rows)
	{
		ddr5__loop__id++;


	templateBuilder.Append("\r\n   <li><a target=\"_blank\" href=\"");
	templateBuilder.Append(linkurl("down_show",ddr5["id"].ToString().Trim()));

	templateBuilder.Append("\">");
	templateBuilder.Append(Utils.DropHTML(ddr5["title"].ToString().Trim(),82));

	templateBuilder.Append("</a><span>( ");	templateBuilder.Append(Utils.ObjectToDateTime(ddr5["add_time"].ToString().Trim()).ToString("yyyy-MM-dd"));
	...
	templateBuilder.Append(linkurl("down_show",model.id));
	...
	templateBuilder.Append(linkurl("down_list1",cdr["id"].ToString().Trim(),1));
	...
	templateBuilder.Append("\">推荐资源</a></h2>\r\n  <ul class=\"news_list\">\r\n   ");
	DataTable down_list8 = get_download_list(channel_id, model.category_id, 8, "is_lock=0 and is_red=1");
	

	int ddr8__loop__id=0;
	foreach(DataRow ddr8 in down_list8.Rows)
	{
		ddr8__loop__id++;


	templateBuilder.Append("\r\n   <li><span>( ");	templateBuilder.Append(Utils.ObjectToDateTime(ddr8["add_time"].ToString().Trim()).ToString("MM-dd"));

	templateBuilder.Append(" )</span><a target=\"_blank\" href=\"");
	templateBuilder.Append(linkurl("down_show",ddr8["id"].ToString().Trim()));

	templateBuilder.Append("\">");
	templateBuilder.Append(Utils.DropHTML(ddr8["title"].ToString().Trim(),32));
