...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"商品展示");
	...
	templateBuilder.Append(model.sell_price.ToString());
	templateBuilder.Append("元</li>\r\n    <!--扩展属性开始-->\r\n    ");
	...
	templateBuilder.Append(linkurl("goods_show",pdr5["id"].ToString().Trim()));
	...
	templateBuilder.Append(linkurl("goods_show",model.id));
	...
	DataTable photo_list10 = get_photo_list(channel_id, model.category_id, 10, "is_lock=0", "digg_good desc,add_time desc");
