...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n  <h2 class=\"page_title\">资源下载");
	templateBuilder.Append(category_nav.ToString());
	templateBuilder.Append("</h2>\r\n  <ul class=\"page_download_list\">\r\n    ");
	DataTable list = get_download_list(channel_id, category_id, 8, page, "", out totalcount);
	

	templateBuilder.Append(" <!--取得一个DataTable-->\r\n    ");
	string pagelist = get_page_link(8, page, totalcount, "down_list1", category_id, "__id__");
	...
	templateBuilder.Append("\r\n    <li><a href=\"");
	templateBuilder.Append(linkurl("down_show",dr["id"].ToString().Trim()));

	templateBuilder.Append("\" class=\"img_in_list\"><img src=\"" + dr["img_url"].ToString().Trim() + "\" alt=\"" + dr["title"].ToString().Trim() + "\" width=\"150\" height=\"150\" /></a><a href=\"");
	templateBuilder.Append(linkurl("down_show",dr["id"].ToString().Trim()));

	templateBuilder.Append("\">" + dr["title"].ToString().Trim() + "</a><i>" + dr["add_time"].ToString().Trim() + "<span>" + dr["click"].ToString().Trim() + " 人气</span></i>\r\n    <p>");
	templateBuilder.Append(Utils.DropHTML(dr["content"].ToString().Trim(),255));
	...
	DataTable down_list1 = get_download_list(channel_id, category_id, 8, "is_lock=0 and is_red=1");
	

	int ddr__loop__id=0;
	foreach(DataRow ddr in down_list1.Rows)
	{
		ddr__loop__id++;


	templateBuilder.Append("\r\n   <li><span>( ");	templateBuilder.Append(Utils.ObjectToDateTime(ddr["add_time"].ToString().Trim()).ToString("MM-dd"));

	templateBuilder.Append(" )</span><a href=\"");
	templateBuilder.Append(linkurl("down_show",ddr["id"].ToString().Trim()));

	templateBuilder.Append("\">");
	templateBuilder.Append(Utils.DropHTML(ddr["title"].ToString().Trim(),32));
