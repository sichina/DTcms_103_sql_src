...
namespace DTcms.Web.Plugin.LineService.DAL
{
    ...
    public partial class online_service_group
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_online_service_group");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 title from dt_online_service_group");
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into dt_online_service_group(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_online_service_group set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_online_service_group set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dt_online_service_group ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public Model.online_service_group GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,title,default_view,sort_id,is_lock from dt_online_service_group ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" FROM dt_online_service_group ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_online_service_group");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
