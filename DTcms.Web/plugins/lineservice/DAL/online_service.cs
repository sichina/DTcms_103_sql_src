...
namespace DTcms.Web.Plugin.LineService.DAL
{
    ...
    public partial class online_service
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_online_service");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_online_service set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_online_service set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dt_online_service ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public Model.online_service GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,group_id,title,img_url,link_url,sort_id,is_lock,add_time from dt_online_service ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" FROM dt_online_service ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_online_service");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
