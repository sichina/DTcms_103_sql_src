...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 插件管理 &gt; 广告管理 &gt; 广告位</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="adv_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加广告位</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="adv_edit.aspx?action=<%=ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
        ...
        <td align="center">
          ...
          <a href="adv_edit.aspx?action=<%=ActionEnum.Edit %>&id=<%#Eval("id")%>">编辑</a>
        </td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
