    ...
    public partial class index : DTcms.Web.UI.ManagePage
    {
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("advert_page_size", _pagesize.ToString(), 43200);
                }
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("index.aspx", "keywords={0}&&property={1}", this.keywords, this.property), "Success");
        }
