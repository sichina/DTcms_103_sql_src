...
namespace DTcms.Web.Plugin.Advert.DAL
{
    ...
    public partial class advert
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_advert");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 title from dt_advert");
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_advert set ");
        ...
        public bool Delete(int id)
        {
            ...
            strSql2.Append("delete from dt_advert_banner ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,title,type,price,remark,view_num,view_width,view_height,target,add_time from dt_advert ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_advert");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
