...
namespace DTcms.Web.Plugin.Advert.DAL
{
    ...
    public partial class advert_banner
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_advert_banner");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into dt_advert_banner(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_advert_banner set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dt_advert_banner ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,aid,title,start_time,end_time,file_path,link_url,content,sort_id,is_lock,add_time from dt_advert_banner ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM dt_advert_banner ");
            if (strWhere.Trim() != "")
            {
