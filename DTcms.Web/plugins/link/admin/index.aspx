...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="link_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">增加链接</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%# Convert.ToInt32(Eval("is_lock")) == 1 ? "<img src=\"../../../" + siteConfig.webmanagepath + "/images/icon_audit.gif\" title=\"未审核\" />" : ""%> <a href="link_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
        ...
        <td align="center"><a href="link_edit.aspx?&action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
