...
namespace DTcms.Web.Plugin.Link.DAL
{
	...
	public partial class link
	{
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_link");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into dt_link(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_link set " + strValue);
            strSql.Append(" where id=" + id);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update dt_link set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from dt_link ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_link");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
